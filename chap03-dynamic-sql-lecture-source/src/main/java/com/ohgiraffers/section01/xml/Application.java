...
public class Application {
    ...
    public static int inputPrice() {
        Scanner sc = new Scanner(System.in);
        System.out.print("검색할 가격대의 금액을 입력해 주세요: ");
    ...
    //    private static void inputSearchCriteria() {
//        do {
//            Scanner sc = new Scanner(System.in);
//            System.out.print("검색 기준을 입력해 주세요(name or category): ");
//            String condition = sc.nextLine();
...
//    }
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("2. 메뉴 혹은 카테고리로 검색, 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, 검색 조건이 없는 경우 전체 검색");
